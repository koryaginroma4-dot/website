...
class ApplicationFactory
{
    public function createFromDTO(ApplicationDTO $applicationDTO): Application
    {
        return (new Application())
            ...
            ->setProjectType($applicationDTO->projectType)
            ->setPreferredStartTime($applicationDTO->preferredStartTime)
            ->setBudgetRange($applicationDTO->budgetRange)
            ->setOwnsProperty($applicationDTO->ownsProperty)
